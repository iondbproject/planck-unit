...
void test_addstuff1_1(planck_unit_test_t *tc)
{
	int a	= 10;
	int b	= 3;
...
void test_stringequals_success(planck_unit_test_t *tc)
{
	char	*a	= "apple";
	char	*b	= "apple";
	PLANCK_UNIT_ASSERT_STR_ARE_EQUAL(tc, a, b);
...
void test_stringnotequals_success(planck_unit_test_t *tc)
{
	char	*a	= "apple";
	char	*b	= "orange";
...
void test_intequals_success(planck_unit_test_t *tc)
{
	int	a	= 10;
	int	b	= 10;
...
void test_intnotequals_success(planck_unit_test_t *tc)
{
	int	a	= 10;
	int	b	= -10;
...
int main(void)
{
	...
	//planck_unit_init_suite(suite, PLANCK_UNIT_MODE_HUMAN);
